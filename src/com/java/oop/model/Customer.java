...
public class Customer implements Comparable<Customer> {
    ...
    public int compareTo(Customer o) {
       /* It returns id in ascending order
        return this.id - o.id;
        */
        // This returns in ascending order
        //return this.name.compareTo(o.name);

        //if u want to get it in descending order then change the places then interchange this.name with o.name positions
